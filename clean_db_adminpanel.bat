...
set DATABASE_NAME=database_adminpanel_bk_1
...
for %%i in (%TABLES_TO_KEEP%) do (
    ...
    %MYSQL_BIN_PATH%\mysql -u %MYSQL_USER%  -e "USE %DATABASE_NAME%; DELETE FROM %%i WHERE school_id <> 78;"
)
